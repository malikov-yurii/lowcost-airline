...
import static com.malikov.lowcostairline.CityTestData.*;
...
public class AirportTestData {
    ...
    public static final List<Airport> AIRPORTS = Arrays.asList(AIRPORT_1_BORISPOL, AIRPORT_2_HEATHROW, AIRPORT_3_LUTON, AIRPORT_4_DA_VINCI);
