...
import static com.malikov.lowcostairline.UserTestData.ADMIN_2;
...
public class TicketServiceImplTest extends AbstractServiceTest {
    ...
    private Ticket getNewDummyTicketWithNullId(Long id) {
        return new Ticket(id, FLIGHT_1, USER_1, new BigDecimal("40.00"), OffsetDateTime.parse("2017-03-20T08:33+01:00"), true, true);
    }
