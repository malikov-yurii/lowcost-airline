...
/*
    ...
    //    Aircraft created = service.create(newAircraft);
    ...
    //    List<String> aircraftByNameMask = service.getNamesByNameMask("73");
    //    MATCHER.assertCollectionEquals(Collections.singleton(AIRCRAFT_1.getName()), aircraftByNameMask);
    //}
