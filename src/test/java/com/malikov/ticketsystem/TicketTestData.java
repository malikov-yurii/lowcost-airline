...
public class TicketTestData {
    ...
    public static final Ticket USER_2_FIRST_TICKET = new Ticket(2L, FLIGHT_2, USER_2, USER_2.getName(), USER_2.getLastName(), new BigDecimal("30.00"),
    ...
    public static final Ticket USER_2_LAST_TICKET = new Ticket(6L, FLIGHT_3, USER_2, USER_2.getName(), USER_2.getLastName(), new BigDecimal("30.00"),
            OffsetDateTime.parse("2017-05-23T08:30+01:00"), false, false, 1, TicketStatus.PAID);

    public static final Ticket FLIGHT_4_USER_6_TICKET = new Ticket(7L, FLIGHT_4, USER_6, USER_6.getName(), USER_6.getLastName(), new BigDecimal("40.00"),
            OffsetDateTime.parse("2017-05-22T08:30+03:00"), false, false, 1, TicketStatus.PAID);

    public static final Ticket FLIGHT_4_USER_7_TICKET = new Ticket(8L, FLIGHT_4, USER_7, USER_7.getName(), USER_7.getLastName(), new BigDecimal("103.00"),
            OffsetDateTime.parse("2017-05-22T09:30+03:00"), true, false, 2, TicketStatus.PAID);

    public static final Ticket SECOND_TICKET_OF_USER_6 = new Ticket(9L, FLIGHT_5, USER_6, USER_6.getName(), USER_6.getLastName(), new BigDecimal("40.00"),
