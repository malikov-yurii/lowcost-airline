                ...
                <div class="modal-body">
                    <form:form class="form-horizontal" method="post" id="detailsForm">
                        ...
                        <sec:authorize access="!hasRole('ROLE_ADMIN')">
                            ...
                            <div class="form-group">
                                <label for="priorityRegistrationAndBoardingPrice" class="control-label col-xs-3"><fmt:message
                                        key="ticket.priorityRegistrationAndBoardingPrice"/></label>

                                <div class="col-xs-9">
                                    <input type="number" class="modal-input form-control" id="priorityRegistrationAndBoardingPrice"
